    ...
    <header className="w-full border-b border-vc-navy/10 bg-vc-beige/80 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <Link 
            href="/" 
            className="text-sm font-bold uppercase tracking-widest hover:text-vc-navy/60 transition-colors"
          >
            Journal
          </Link>
          ...
          <Link 
            href="/about" 
            className="text-sm font-bold uppercase tracking-widest hover:text-vc-navy/60 transition-colors border-l border-vc-navy/10 pl-8"
          >
            About
          </Link>
        </nav>
